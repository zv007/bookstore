package com.zv.bookstore.user.web.servlet;
...
import com.zv.bookstore.user.service.UserException;
import com.zv.bookstore.user.service.UserService;
...
public class UserServlet extends BaseServlet {
	...
	public String regist(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(username==null || username.trim().isEmpty()){
			...
			errors.put("username", "用户名长度必须在3~10之前");
		}
		...
		if(password==null || password.trim().isEmpty()){
			...
			errors.put("password", "密码长度必须在3~10之前");
		}
		...
		String uname=prop.getProperty("uname");//获取用户名
		...
		content=MessageFormat.format(content, form.getCode());//占位符替换为code
